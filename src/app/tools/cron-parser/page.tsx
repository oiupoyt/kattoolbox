  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        {/* Top Preset Gallery */}
        <div className=" border border-[#1a1a1a] bg-black/70 p-4 space-y-3 shadow-xs">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#1a1a1a]/80 pb-2">
            ...
            {PRESETS.map((p) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5  text-xs transition-all cursor-pointer flex items-center gap-2 border ${
                    isSelected
                      ? "bg-blue-600 border-blue-600 text-white font-semibold shadow-xs"
                      : "bg-[#0a0a0a] border-[#1a1a1a] text-gray-400 hover:bg-[#0a0a1a] hover:border-blue-300"
                  }`}
                >
                  <span>{p.name}</span>
                  <code
                    className={`font-mono text-[11px] px-1 py-0.5 ${
                      isSelected
        ...
        <div className=" border border-[#1a1a1a] bg-[#0a0a0a] p-5 shadow-xs space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <label htmlFor="cron-main-input" className="text-sm font-bold text-gray-200">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-2.5 py-1 bg-[#111] hover:bg-[#1a1a1a] text-gray-400 text-xs font-medium transition-colors cursor-pointer flex items-center gap-1"
              >
          ...
          <div className="relative">
            <input
              ...
              placeholder="* * * * *"
              className="w-full p-4 font-mono text-xl sm:text-2xl tracking-wider  border border-[#1a1a1a] bg-[#0a0a0a] text-gray-200 focus:ring-1 focus:ring-blue-900 focus:outline-none shadow-inner"
            />
          </div>

          {/* Human Readable Explanation Banner */}
          {parsedCron.valid ? (
            <div className="flex items-start gap-3 p-4  border border-emerald-200 bg-emerald-50/70 text-emerald-900">
              <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-none bg-emerald-500 text-white text-xs font-bold mt-0.5">
                ✓
              </span>
              <div>
            ...
            <div className="flex items-start gap-3 p-4  border border-rose-200 bg-rose-50/80 text-rose-900">
              <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-none bg-rose-500 text-white text-xs font-bold mt-0.5">
                !
              </span>
              <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            {FIELDS.map((fDef, idx) => {
              ...
              return (
                <div
                  key={fDef.key}
                  className={`flex flex-col justify-between p-3.5  border transition-all ${
                    isValid
                ...
                >
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      placeholder="*"
                      className="w-full p-2 font-mono text-base font-bold text-center  border border-[#1a1a1a] bg-black text-gray-200 focus:ring-1 focus:ring-blue-900 focus:outline-none"
                    />
        ...
        <div className=" border border-[#1a1a1a] bg-[#0a0a0a] p-5 shadow-xs space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-100 pb-3">
            <div className="flex items-center gap-2">
              <span className="flex h-6 w-6 items-center justify-center rounded-none bg-[#0a0a1a] text-blue-400 text-xs font-bold">
                ⏰
              </span>
              <h3 className="text-sm font-bold text-gray-200">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-1.5 text-xs">
                ...
                <div className="inline-flex  border border-[#1a1a1a] p-0.5 bg-[#111]">
                  <button
                    type="button"
                    onClick={() => setTimezone("local")}
                    className={`px-2 py-0.5 text-xs font-medium transition-colors cursor-pointer ${
                      timezone === "local"
              ...
              <div className="flex items-center gap-1.5 text-xs">
                ...
                <select
                  ...
                  className="p-1 border border-[#1a1a1a] bg-[#0a0a0a] text-gray-200 text-xs focus:outline-none"
                >
              ...
              <button
                ...
                className="px-3 py-1 bg-[#111] hover:bg-[#1a1a1a] text-gray-400 disabled:opacity-40 text-xs font-medium transition-colors cursor-pointer"
              >
            ...
            <div className="divide-y divide-gray-100 max-h-[420px] overflow-y-auto">
              {nextRuns.map((date, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="flex flex-col sm:flex-row sm:items-center justify-between py-2.5 px-2 hover:bg-black  transition-colors text-xs"
                  >
                    <div className="flex items-center gap-3">
                      <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-none bg-[#111] text-[11px] font-mono font-bold text-gray-500">
                        {idx + 1}
                      </span>
                      <div>
                    ...
                    <div className="mt-1 sm:mt-0 flex items-center gap-3">
                      <span className="px-2 py-0.5 rounded-none bg-[#0a0a1a] text-blue-400 font-medium">
                        {relative}
                      </span>
        ...
        <div className="mt-8 pt-6 border-t border-[#1a1a1a] space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
            <div className="p-3 bg-black  border border-[#1a1a1a] space-y-1">
              <div className="font-mono font-bold text-blue-600 text-sm">* (Asterisk)</div>
              <p className="font-semibold text-gray-300">Wildcard (Any Value)</p>
              <p className="text-gray-500">
                Matches every possible value in the field. E.g. <code className="bg-[#1a1a1a] px-1 rounded">*</code> in hour means every hour.
              </p>
            </div>

            <div className="p-3 bg-black  border border-[#1a1a1a] space-y-1">
              <div className="font-mono font-bold text-blue-600 text-sm">, (Comma)</div>
              <p className="font-semibold text-gray-300">Value List</p>
              <p className="text-gray-500">
                Specifies discrete multiple values. E.g. <code className="bg-[#1a1a1a] px-1 rounded">1,15,30</code> in minute runs at minutes 1, 15, 30.
              </p>
            </div>

            <div className="p-3 bg-black  border border-[#1a1a1a] space-y-1">
              <div className="font-mono font-bold text-blue-600 text-sm">- (Hyphen)</div>
              <p className="font-semibold text-gray-300">Range of Values</p>
              <p className="text-gray-500">
                Specifies an inclusive range. E.g. <code className="bg-[#1a1a1a] px-1 rounded">1-5</code> in weekday means Monday through Friday.
              </p>
            </div>

            <div className="p-3 bg-black  border border-[#1a1a1a] space-y-1">
              <div className="font-mono font-bold text-blue-600 text-sm">/ (Slash)</div>
              <p className="font-semibold text-gray-300">Step Values</p>
              <p className="text-gray-500">
                Specifies step increments. E.g. <code className="bg-[#1a1a1a] px-1 rounded">*/15</code> in minute runs every 15 minutes.
              </p>
            </div>
          </div>
        </div>
